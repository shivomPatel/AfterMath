          ...
          <header className="hero bg-black text-color-white global-padding-vertical overlay">
            <div className="area align-center text-center row">
              <h1 className="small-12 medium-6 columns">
                <span className="font-weight-regular">Reviews</span>
                <br />
                <span className="font-size-xxlarge text-uppercase">
                  WEHKAMP
                </span>
              </h1>
            </div>
  ...
  submitForm(event) {
    ...
    if (
      ...
      this.setState({
        ...this.state,
        validation: (
          <div className="validation">Niet alle velden zijn ingevuld</div>
        ),
      });
